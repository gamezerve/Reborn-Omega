...
// Reborn: Preserve the existing texture filtering and antialiasing options.
...
#if !_DEBUG
// Reborn: The custom client distribution does not ship the official GO Sentry runtime.
